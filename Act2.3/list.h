...
T DoubleLinkedList<T>::before(T val) const {
	...
	while ((p != NULL)||(found==true)){			//O(N)
		if (p->value==val){			//O(1)
			if (p->previous==NULL){			//O(1)
				throw NoSuchElement();			//O(1)
				found = true;			//O(1)
			}
			else{
				found = true;			//O(1)
...
void DoubleLinkedList<T>::insert_before(T lookingFor, T newVal) {
	...
	while ((p != NULL)&&(found!=true)){			//O(N)
		if (p->value==lookingFor){			//O(1)
			if (p->previous==NULL){			//O(1)
				found = true;			//O(1)
				push_front(newVal);			//O(1)
				break;			//O(1)
			}
			else{
				found = true;			//O(1)
				q = p->previous;			//O(1)
				nuevo = new Node<T>(newVal);			//O(1)
				nuevo->next = p;			//O(1)
				nuevo->previous = q;			//O(1)
				q->next=nuevo;			//O(1)
				p->previous=nuevo;			//O(1)
				size++;			//O(1)
				break;			//O(1)
			}
		}
	...
	while ((p != NULL)&&(found!=true)){			//O(N)
		if (p->value==lookingFor){			//O(1)
			if (p->next==NULL){			//O(1)
				...
				nuevo = new Node<T>(newVal);			//O(1)
				nuevo->next = q;			//O(1)
				nuevo->previous = p;			//O(1)
				p->next=nuevo;			//O(1)
				q->previous=nuevo;			//O(1)
				size++;			//O(1)
				break;			//O(1)
			}
		}
